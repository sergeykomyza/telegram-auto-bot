...
export class BotDatabase {
  ...
  updateLastPostId(vkName: string, postId: number) {
    const stmt = this.db.prepare(`
  ...
  isPostProcessed(vkName: string, postId: number): boolean {
    const stmt = this.db.prepare(`
  ...
  markPostProcessed(vkName: string, postId: number, status: 'posted' | 'filtered' | 'error') {
